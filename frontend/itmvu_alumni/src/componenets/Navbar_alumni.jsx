...
const Navbar = () => {
  ...
  const navLinks = [
    { name: "Home", path: "/dashboard", icon: "ri-home-7-line", activeIcon: "ri-home-7-fill" },
    { name: "Post", path: "/alumni_post", icon: "ri-add-box-line", activeIcon: "ri-add-box-fill" },
    { name: "Jobs", path: "/job", icon: "ri-briefcase-4-line", activeIcon: "ri-briefcase-4-fill" },
    { name: "Mentorship", path: "/mentorship", icon: "ri-team-line", activeIcon: "ri-team-fill" },
    { name: "Donate", path: "/donate", icon: "ri-hand-coin-line", activeIcon: "ri-hand-coin-fill" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center cursor-pointer" onClick={() => navigate("/dashboard")}>
            {/* Using a stylized text or actual logo */}
            {logo ? (
          ...
          <div className="flex items-center space-x-4 lg:space-x-6 pl-4">
            ...
            <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => navigate("/profile")}>
              ...
              <div className="hidden lg:block text-sm">
                <p className="text-gray-900 font-medium leading-none">Bhavesh M.</p>
                <p className="text-gray-500 text-xs mt-1">Alumni</p>
              </div>
            </div>
